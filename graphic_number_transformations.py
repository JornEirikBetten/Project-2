...
plt.xlabel(r'$Log_2(N)$', fontsize=18)
plt.ylabel(r'$Log_2(Iterations)$', fontsize=18) 
plt.title(r'The number of transformations versus matrix size', fontsize=20)
plt.legend()
plt.savefig("IterationsvsNtridiag.pdf")
plt.show()
